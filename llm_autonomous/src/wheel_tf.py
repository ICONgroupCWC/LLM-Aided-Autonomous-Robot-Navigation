...
class LowLevelCtrl():
    def __init__(self, wheel_distance=0.162, wheel_diameter=0.065):
        ...
        self.ros_pub_velocity_array = rospy.Publisher("/jb_0/wheel_velocity", Float32MultiArray, queue_size=1)
 
        self.ros_pub_joint_stat     = rospy.Publisher("/jb_0/joint_states", JointState, queue_size=10)


        rospy.loginfo("> Publisher corrrectly initialized")

        #--- Create the Subscriber to Twist commands
        self.ros_sub_twist          = rospy.Subscriber("/jb_0/cmd_vel", Twist, self.set_actuators_from_cmdvel)
